...
<form name="supplier" id="validate" class="form" action="index.php?com=bannerqc&act=save_banner_giua<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
  <div class="widget">
    ...
    <div class="formRow lang_hidden lang_vi active">
      ...
      <div class="mt10">
         <object width="290" height="100"  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
             ...
             <embed src="<?=_upload_hinhanh.$item['photo_vi']?>" quality="High" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="290" height="100" scale="ExactFit"></embed>
            </object>
      </div>
      </div>
      <div class="clear"></div>
    ...
    <div class="formRow lang_hidden lang_en">
      ...
      <div class="mt10">
         <object width="290" height="100"  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
              ...
              <param NAME="AllowFullScreen" VALUE="false">
              <param name="scale" value="ExactFit">
             <embed src="<?=_upload_hinhanh.$item['photo_en']?>" quality="High" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="290" height="100" scale="ExactFit"></embed>
            </object>
      </div>
      </div>
      <div class="clear"></div>
