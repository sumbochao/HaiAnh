...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=product&act=man_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span><?=$config_cap1['title']?></span></a></li>
            <?php if($_GET['keyword']!=''){ ?>
...
<form name="f" id="f" method="post">
  <div class="control_frm" style="margin-top:0;">
    	<div style="float:left;">
      	 <input type="button" class="greenB" value="Thêm" onclick="location.href='index.php?com=product&type=<?=$_GET['type']?>&act=add_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>'" />
      ...
      <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
        <thead>
          <tr>
            ...
            <?php } ?>     
            <td align="left" class="sortCol"><div>Tên danh mục<span></span></div></td>
            <?php if($config_cap1['noibat']==true){ ?>
        ...
        <tbody>
          ...
          <tr>
           <td>
            ...
            <td class="actBtns">
                <a href="index.php?com=product&act=edit_list&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Sửa <?=_title?>"><img src="./images/icons/dark/pencil.png" alt=""></a>

                <a href="index.php?com=product&act=delete_list&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Xác nhận xóa')) return false;" title="" class="smallButton tipS" original-title="Xóa <?=_title?>"><img src="./images/icons/dark/close.png" alt=""></a>
            </td>
          </tr>
          <?php } ?>
        </tbody>
