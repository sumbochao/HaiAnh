    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      <thead>
        <tr>
          ...
          <td align="left" class="sortCol"><div>Tên <?=_title?><span></span></div></td>
          <?php if($config_pr['spmoi']==true){ ?>
          <td style="width: 80px; text-align: center;">Mới</td>
          <?php } ?>
          <?php if($config_pr['noibat']==true){ ?>
          <td style="width: 80px; text-align: center;">Nổi bật</td>
          <?php } ?>
          <?php if($config_pr['banchay']==true){ ?>
          <td style="width: 80px; text-align: center;">Bán chạy</td>
          <?php } ?>
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php if($config_pr['banchay']==true){ ?>
          <td align="center">
            <a data-val2="table_product" rel="<?=$items[$i]['banchay']?>" data-val3="banchay" class="diamondToggle <?=($items[$i]['banchay']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a>   
          </td>
          <?php } ?>
          ...
          <td class="actBtns">
              <a href="index.php?com=product&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id_sub=<?=$items[$i]['id_sub']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Sửa <?=_title?>"><img src="./images/icons/dark/pencil.png" alt=""></a>

              <a href="index.php?com=product&act=delete&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Xác nhận xóa')) return false;" title="" class="smallButton tipS" original-title="Xóa <?=_title?>"><img src="./images/icons/dark/close.png" alt=""></a>
          </td>
        </tr>
