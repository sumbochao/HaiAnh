     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <?php foreach ($config['lang'] as $key => $value) { ?>     
            ...
            <div class="formRight">
                <input type="text" name="ten_vi" title="Nhập tên bài viết" id="ten_vi" class="tipS" value="<?=@$item['ten_vi']?>" />
            </div>
            <div class="clear"></div>
        </div>  
        ...
        <div class="formRow">
            ...
            <div class="ck_editor">
                <textarea class="ck_editors"  rows="8" cols="" title="Viết mô tả ngắn bài viết" class="tipS" name="mota_vi" id="mota_vi"><?=@$item['mota_vi']?></textarea>
            </div>
            <div class="clear"></div>
        </div>  
            ...
            <div class="ck_editor"><textarea class="ck_editors" name="noidung_vi" id="noidung_vi" rows="8" cols="60"><?=@$item['noidung_vi']?></textarea>
</div>
            <div class="clear"></div>
        </div>
