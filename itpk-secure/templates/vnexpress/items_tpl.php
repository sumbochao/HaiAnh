...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
    	<input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=vnexpress&act=add&type=tin-tuc'" />
    ...
    <tbody>
       ...
       <td>
        ...
        <td class="title_name_data">
            <a href="index.php?com=vnexpress&act=edit&id=<?=$items[$i]['id']?>&hienthi=<?=$items[$i]['hienthi']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold"><?=$items[$i]['ten_vi']?></a>
        </td>
       ...
       <td align="center">
        ...
        <td class="actBtns">
            ...
            <a href="index.php?com=vnexpress&act=delete&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" onClick="if(!confirm('Xác nhận xóa <?=$items[$i]['ten_vi']?>')) return false;" title="" class="smallButton tipS" original-title="Xóa bài viết"><img src="./images/icons/dark/close.png" alt=""></a>
        </td>
      </tr>
         <?php } ?>
                </tbody>
